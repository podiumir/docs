...
با استفاده از این سرویس شما می‌توانید برای کاربران خود کیف پول تعریف نمایید، همچنین برای کاربران‌تان درازای خرید محصولات یا برخورداری از خدمات کسب‌وکارشان، فاکتور صادر نمایید و پرداخت آن را پیگیری نمایید.  توجه داشته باشید که استفاده از کیف پول پاد در کسب‌وکارهایی که می‌خواهند از سرویس‌های پاد استفاده کنند یکی از شروط اصلی است.
