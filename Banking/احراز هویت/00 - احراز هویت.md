...
- [SSO](#sso)    
- [نصب پکیج pod-sso-service](#نصب-پکیج-pod-sso-service)    
- [دریافت توکن دسترسی کاربر](#دریافت-توکن-دسترسی-کاربر)   
- [بروزرسانی توکن دسترسی کاربر](#بروزرسانی-توکن-دسترسی-کاربر)   
- [ابطال توکن](#ابطال-توکن)    
- [دریافت اطلاعات توکن](#دریافت-اطلاعات-توکن)
- [OTP](#otp)    
- [ورود با OTP با سرور](#ورود-با-otp-با-سرور)    
- [فراخوانی سرویس Handshake سمت SSO](#فراخوانی-سرویس-handshake-سمت-sso)    
- [درخواست دریافت کد OTP](#درخواست-دریافت-کد-otp)    
- [تایید کد OTP](#تایید-کد-otp)    
- [دریافت توکن از سرور SSO](#دریافت-توکن-از-سرور-sso)
