...
<br/>
1. کاربر با تایید شماره موبایل خود (از طریق ارسال کد پیامک شده یا بازیابی رمز عبور با کد پیامک شده، به سطح اول می رسد. در این سطح کاربر دارای شرایط مالی زیر است:
* سقف موجودی: 1 میلیون تومان
* سقف قابل شارژ در کیف پول، روزانه: 200 هزار تومان
* سقف قابل انتقال (به کاربر دیگر یا برداشت از کیف پول)، روزانه: 200 هزار تومان
* سقف برداشت مستقیم از حساب بانکی (direct debit)، روزانه: 200 هزار تومان
<br/>
2. کاربر سطح اول می تواند با ثبت کد ملی خود در صورتی که شماره موبایل تایید شده متعلق به کد ملی خودش باشد، به سطح دوم ارتقا پیدا کند. در این سطح کاربر دارای شرایط مالی زیر است:
* سقف موجودی: 10 میلیون تومان
* سقف قابل شارژ در کیف پول، روزانه: 3 میلیون تومان
* سقف قابل انتقال (به کاربر دیگر یا برداشت از کیف پول)، روزانه: 3 میلیون تومان
* سقف برداشت مستقیم از حساب بانکی (direct debit)، روزانه: 200 هزار تومان
<br/>
3. کاربر سطح دوم می تواند با ثبت تاریخ تولد خود به صورت خودکار از ثبت احوال استعلام گردد و به سطح سوم ارتقا پیدا کند. در این سطح کاربر دارای شرایط مالی زیر است:
* سقف موجودی: 10 میلیون تومان
* سقف قابل شارژ در کیف پول، روزانه: 3 میلیون تومان
* سقف قابل انتقال (به کاربر دیگر یا برداشت از کیف پول)، روزانه: 3 میلیون تومان
* سقف برداشت مستقیم از حساب بانکی (direct debit)، روزانه: 200 هزار تومان
<br/>
4. کاربر پاد در هر لحظه می تواند به صورت حضوری مشتری بانک پاسارگاد شده و با در صورت مشتری بودن، با استفاده از احراز هویت اینترنت بانک پاسارگاد به سطح چهارم ارتقا پیدا کند. در این سطح کاربر دارای شرایط مالی زیر است:
* سقف موجودی: نا محدود
* سقف قابل شارژ در کیف پول، روزانه: ۵۰ میلیون تومان
* سقف قابل انتقال (به کاربر دیگر یا برداشت از کیف پول)، روزانه: ۵۰ میلیون تومان
* سقف برداشت مستقیم از حساب بانکی (direct debit)، روزانه: 200 هزار تومان
<br/>
