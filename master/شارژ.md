...
با این سرویس می توانید حداقل و حدااکثر مبلغ خرید شارژمستقیم را به تفکیک اپراتور و طرح خرید شارژ دریافت نمایید. همچنین آیتم step نمایانگر روند افزایشی مبالغ است. برای مثال، حداقل مبلغ 10000 و حدااکثر مبلغ 2000000 ریال برای طرح عادی همراه اول، که مبالغ به صورت 1000 ریالی افزایش داده می شود (یعنی 11000 ریال، 12000 ریال و ...)
...
پس از ایجاد فاکتور و برای دریافت شارژ و یا بسته اینترنتی api زیر صدا زده می شود:
