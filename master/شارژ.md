...
برای استفاده از سرویس‌های فوق، لازم است در پنل شارژپلاس وارد شوید، اپلیکیشن خود را در آن تعریف نموده و Bearer  Authentication Token  خود را دریافت نمایید
برای ورود به پنل شارژپلاس از لینک زیر استفاده نمایید:
https://charge.fanap.plus
پس از لاگین و ورود یه پنل شارژپلاس، اطلاعات کسب‌وکار خود را مشاهده نموده و اپلیکیشن‌های خود را تعریف کنید.
