...
## ورود به پنل شارژ پلاس
برای استفاده از سرویس‌های فوق، لازم است در پنل شارژپلاس ثبت‌نام وارد شوید و کسب‌وکار یا اپلیکیشن خود را در آن تعریف نمایید.
برای ورود به پنل فوق از لینک زیر استفاده کنید:
[پنل شارژپلاس](https://charge.fanap.plus/(
پس از لاگین و ورود یه پنل شارژپلاس، لازم است تا اطلاعات کسب‌وکار خود را مشاهده و اپلیکیشن‌های خود را تعریف نمایید.
