...
- [پیوست 1 - لیست کد بانک‌ها](#menu)
- [پیوست 2 - کانال پرداخت](#menu)
- [پیوست 3 - لیست شرکتهای توزیع برق به همراه کد](#menu)
- [پیوست 4 - نوع گزارش](#menu)
- [پیوست 5 - نوع پیام](#menu)
- [پیوست 6 - کدهای خطا](#menu)
...
```
* مواردی که با * مشخص شده اند اجباری میباشند.
* خروجی تمامی وب سرویسها با فرمت json  و دارای ساختار زیر است :
...
در صورتی که عملیات با موفقیت انجام شود کد مربوط به status برابر 200 خواهد بود و در صورتی که نیاز باشد تابع اطلاعاتی را برگرداند، مقدار در فیلد data قرار خواهد گرفت. و در صورتی که با خطا مواجه گردد status برابر 500 خواهد بود و خطاهای پیش امده در فیلد Errors قرار خواهند گرفت که کد خطاها از 500 شروع میشوند. در شکل زیر یک نمونه خطای برگشتی نمایش داده شده است:
...
|yyyy-MM-dd'T'hh:mm:ss'Z'|فرمت تاریخ|
|---|----|
|2019-05-08T10:06:04Z|نمونه|
|yyyy|سال میلادی 4 رقم|
|MM|عدد ماه|
|dd|عدد روز|
|hh|ساعت|
|mm|دقیقه|
...
**الزامات مربوط به متقاضیان استفاده از سامانه :**

متقاضیانی که برای ارائه الکترونیکی قبوض به مشترکین برق خواهان استفاده از خدمات این سامانه میباشند نیاز است تا خدمات پایه مورد نظر توانیر را در سامانه های خود ارائه دهند. این خدمات به شرح زیر میباشد:

* نمایش اطلاعات مشترک (آیتمهای موجود در قبض)
* نمایش قبض های صادر شده برای مشترک (تمامی آیتمهای قبض به همراه بدهی انشعاب، مصرفی و سایر خدمات)
* نمایش سوابق پرداختی مشترک (مبلغ پرداختی، تاریخ پرداخت، بانک عامل، شماره پیگیری)
* امکان نمایش پیام های ارسالی از طرف شرکت توزیع برق
* امکان ثبت نحوه صدور قبض به دلخواه مشترک (قبض فیزیکی چاپ شود یا خیر)
* امکان ثبت چند شناسه قبض
* گواهی امنیت نرم افزار
* ثبت نام با کد تایید پیامکی به همراه کد ملی (شناسه ملی) کاربر و شناسه قبض
* پشتیبانی از اندروید و iOS

اطلاعات ذکر شده در این خدمات از طریق وب سرویس­های سامانه قابل دسترسی خواهد بود. استفاده کنندگان از سامانه بایستی پروتکل های گفته شده در این مستند را رعایت نمایند.
  
  
در فراخوان status پروتکل http بر اساس جدول زیر توجه شود :

|HttpStatus|شرح|
|---|----|
|200|عملیات انجام شد و نتیجه در فیلد data مقدار برگشتی قرار گرفته است |
|400|خطا در فراخوانی وب سرویس (مانند خطای اعتبارسنجی)|
|401|عدم دسترسی|
|500|خطای داخلی در سمت سرور رخ داده است|
...
|-----|------|------|------|------|
|شماره منحصر به فرد مشترک|کد شرکت 3ر قم میباشد.رقم اول اگر 0 یا 1 باشد یعنی فروش انرژِی / اگر 2 یا 3 باشد یعنی بابت فروش انشعاب/اگر برابر 4 یا 5 باشد یعنی بابت خدمات پس از فروش میباشد.لیست شرکتها در پیوست آمده است|کد شرکت خدماتی برای برق به طور ثابت می باشد| رقم کنترل بر اساس فرمول مبنای 11 می باشد| توضیحات 
...
## پیوست 1- لیست کد بانک‌ها

فیلد مربوط به کد بانک بایستی بر اساس ساختار زیر باشد :
|نام بانک|کد|
|----|----|
|بانک صنعت و معدن|11|
|بانک ملت|12|
...
|بانک تجارت|18|
|بانک صادرات|19|
|بانک توسعه صادرات|20|
|پست بانک|21|
|توسعه تعاون|22|
|کاهش بدهی|43|
|موسسه توسعه اعتباری|51|
|بانک قوامین|52|
|بانک کارآفرین|53|
|بانک پارسیان|54|
|بانک اقتصاد نوین|55|
...
## پیوست 2 - کانال پرداخت

کانال پرداخت بایستی بر اساس ساختار زیر مشخص گردد
...
## پیوست 3 - لیست شرکتهای توزیع برق به همراه کد
|شرکت توزیع|کد|
|-----|----|
|برق منطقه‌ای آذربایجان|10|
|توزیع نیروی برق تبریز|11|
|توزیع نیروی برق آذربایجان شرقی|12|
|توزیع نیروی برق آذربایجان غربی|13|
|توزیع نیروی برق اردبیل|14|
|برق منطقه‌ای اصفهان|20|
|توزیع نیروی برق شهرستان اصفهان|21|
|توزیع نیروی برق استان اصفهان|22|
|توزیع نیروی برق چهارمحال و بختیاری|23|
|برق منطقه‌ای باختر|30|
|توزیع نیروی برق استان مرکزی|31|
|توزیع برق نیروی استان همدان|32|
|توزیع نیروی برق استان لرستان|33|
|برق منطقه‌ای تهران|40|
|توزیع نیروی برق استان تهران|42|
|توزیع نیروی برق استان البرز|43|
|توزیع نیروی برق استان قم|44|
|برق منطقه‌ای خراسان|50|
|توزیع نیروی برق شهرستان مشهد|51|
|توزیع نیروی برق استان خراسان|52|
|توزیع نیروی برق استان خراسان شمالی|53|
|توزیع نیروی برق استان خراسان جنوبی|54|
|برق منطقه‌ای خوزستان|60|
|توزیع نیروی برق شهرستان اهواز|61|
|توزیع نیروی برق استان خوزستان|62|
|توزیع نیروی برق کهگیلویه و بویراحمد|63|
|برق منطقه‌ای زنجان|70|
|توزیع نیروی برق استان زنجان|71|
|توزیع نیروی برق استان البرز|72|
|برق منطقه‌ای سمنان|80|
|توزیع نیروی برق استان سمنان|81|
|برق منطقه‌ای سیستان|90|
|توزیع نیروی برق استان سیستان و بلوچستان|91|
|برق منطقه‌ای غرب|100|
|توزیع نیروی برق استان کرمانشاه|101|
|توزیع نیروی برق استان کردستان|102|
|توزیع نیروی برق استان ایلام|103|
|برق منطقه‌ای فارس|110|
|توزیع نیروی برق شهرستان شیراز|111|
|توزیع نیروی برق استان فارس|112|
|توزیع نیروی برق استان بوشهر|113
|برق منطقه‌ای کرمان|120|
|توزیع نیروی برق شمال استان کرمان|121|
|توزیع نیروی برق جنوب استان کرمان|122|
|برق منطقه‌ای گیلان|130|
|توزیع نیروی برق استان گیلان|131|
|برق منطقه‌ای مازندران|140|
|توزیع نیروی برق مازندران|141|
|توزیع نیروی برق غرب مازندران|142|
|توزیع برق گلستان|143|
|برق منطقه‌ای هرمزگان|150|
|توزیع نیروی برق استان هرمزگان|151|
|برق منطقه‌ای یزد|160|
|توزیع نیروی برق استان یزد|161|
...
|انتقاد یا پیشنهاد|1|
|اعلام خاموشی|2|
|اعلام خسارت به شبکه|3|
|اعلام استفاده غیرمجاز از شبکه|4|
|اعلام کانون خطر|5|
|درخواست بررسی ضعف برق(نوسان)|6
...
پیام|کد|
|----|----|
|قبض جدید صادر شده است|1|
|اخطار قطع|2|
|اعلام خاموشی|2|
|پیام مدیریت مصرف|3|
|پیام خدمات مشترکین|4|
...
|نوع خطا|کد|
|-----|-----|
|خطای ناشناخته یا خطای سیستمی|500|
|ورودی نامعتبر می‌باشد|501|
|شناسه قبض نامعتبر است|502|
|کدملی نامعتبر است|503|
|شماره تلفن نامعتبر است|504|
|شناسه پرداخت نامعتبر می باشد|505|
|هم اکنون این شرکت سرویس‌دهنده این شناسه قبض در سامانه فعال نمی‌باشد|506|
|شناسه قبض متعلق به برق نمی‌باشد|507|
|نام کاربری یا کلمه عبور صحیح نمی‌باشد|508
|خطا در ارتباط با شرکت توزیع (عدم دسترسی)|509|
|شماره تلفن همراه داده شده در سیستم ثبت نشده است|510|
|شناسه قبض داده شده برای این شماره موبایل ثبت نشده است|511|
|این نام کاربری قبلا استفاده شده است|512|
|توکن دسترسی نامعتبر می‌باشد|513|
|کلمه عبور جدید و تایید کلمه عبور یکسان نمی‌باشد|514|
|شماره همراه وارد شده برای کاربر مطابقت ندارد|515|
|پاسخ یادآوری کلمه عبور صحیح نمی‌باشد|516|
|خطای سامانه موبایل برق|517|
|اطلاعات در جدول version موجود نیست|518|
|این شماره موبایل قبلا ثبت نام کرده است|519|
|این شماره موبایل قبلا ثبت‌نام نکرده است|520|
|کد منقضی شده است با نامعتبر می‌باشد|521|
|کد ارسال شده اشتباه است|522|
|اشکال در اتصال به سرور پیامک|523|
|Token ارسال شده خالی است|524|
|کد تایید معتبر نیست|525|
|کدپیگیری نامعتبر است|526|
|تعداد درخواست‌ها درواحد زمان بیش از اندازه مجاز می‌باشد|527|
|در حال حاضر این خدمت در دسترس نیست|528|
