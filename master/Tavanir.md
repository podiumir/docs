...
## سرویس ثبت شناسه قبض
برای این‌که یک ذینفع بتواند به اطلاعات مشترکین برق در سامانه دسترسی داشته باشد ابتدا لازم است که شناسه قبض مشترک را در سامانه به همراه کدملی کاربری که نیاز به اطلاعات آن مشترک دارد را در سامانه ثبت نماید.این‌کار با فراخوانی وب‌سرویس Addbill انجام می‌گردد.
