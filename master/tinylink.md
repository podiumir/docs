...
از این سرویس برای فراخوانی یک ملاقات برای لینک/متن/فایل استفاده می‌شود. این سرویس، مقدارhash را دریافت می‌کند و برای لینک/متن متناظر با این لینک کوتاه، یک مشاهده ثبت می‌کند.
